...
MAX_RUN_HISTORY = 20
# Parse-cache caps (:mod:`anqa.bounded_cache`). Entries are keyed per session,
...
TIMELINE_CACHE_MAX_ENV = "ANQA_TIMELINE_CACHE_MAX"
...
# Search-as-you-type idle gap (session list, Timeline). Same as desktop
# ``SEARCH_DEBOUNCE_MS`` (280).
SEARCH_DEBOUNCE_S = 0.28
