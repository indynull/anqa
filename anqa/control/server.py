...
# ``<!-- anqa:… -->`` machine tags of every projection; whitespace, ``-->``
...
def default_socket_path() -> Path:
    ...
    root = Path(runtime) if runtime else Path.home() / ".anqa" / "run"
    return root / "anqa" / "control.sock" if runtime else root / "control.sock"
