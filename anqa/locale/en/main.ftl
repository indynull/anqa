...
# --- UI strings (no hardcoded English in anqa/ui) ---
...
ui-none-host-anqa-gh-token-gh-token-only-if-orche = none (host GH_TOKEN only if orchestrator allows)
